from PyQt5.QtWidgets import QApplication, QMainWindow, QTextEdit, QStackedWidget, QWidget,QGridLayout, QVBoxLayout, QHBoxLayout, QLineEdit, QScrollArea, QPushButton, QFrame, QLabel, QSizePolicy
...
class ChatSection(QWidget):
    ...
    def addMessage(self, message, color):
        ...
        formatim = QTextBlockFormat()
        formatim.setTopMargin(10)
        formatim.setLeftMargin(10)
        format.setForeground(QColor(color))
        cursor.setCharFormat(format)
        cursor.setBlockFormat(formatim)
